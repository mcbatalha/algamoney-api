...
//		refreshTokenCookie.setSecure(false); // Mudar para true em producao  // Sem o ApiProperties
		refreshTokenCookie.setSecure(algamoneyApiProperty.getSeguranca().isEnableHttps()); // Com o ApiProperties
